...
setClass(
  ...
  validity = function(object){
    ...
    if (length(IntervalsLimits) != 2) stop('[HRFactorParam validation] IntervalsLimits debe ser un vector de tipo character de longitud 2 con los nombres de los limites de los intervalos.')
